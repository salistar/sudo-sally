...
function board(x,y,sz,b,g){var cell=sz/9;
 ...
 for(var i=0;i<=9;i++){var M=i%3===0;ctx.strokeStyle=M?'rgba(124,92,255,0.55)':'#262640';ctx.lineWidth=M?2.5:1;
 ...
 ctx.strokeStyle='#7c5cff';ctx.lineWidth=3;ctx.strokeRect(x,y,sz,sz);
